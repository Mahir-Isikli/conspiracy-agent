# LiveKit Agents Voice Assistant
# Simple voice agent without database functionality
...
class VoiceAssistant(Agent):
    """
    Simple Voice AI Assistant using LiveKit Agents framework
    """
...
- You maintain a warm and professional tone
- You can engage in natural conversation
- You aim to be concise but informative
</persona>

<conversation_style>
- Keep responses conversational and natural
- Be patient and helpful with any questions
- Ask clarifying questions when needed
- Maintain a friendly tone throughout
</conversation_style>

You can help with general questions, have conversations, and provide information on various topics.""",
        )
